...
// import { AddMutataion } from "../../../query/useTodosQuery";
...
function Input() {
  ...
  // const {mutate : addTodo} = AddMutataion()
  // console.log('input맞나',mutation);
  // title의 변경을 감지하는 함수
 ...
 // const {mutate : AddMutate} =  AddMutataion()
    // todo를 추가하는 reducer 호출
    // 인자 : payload
    mutation.AddMutataion(newTodo);
